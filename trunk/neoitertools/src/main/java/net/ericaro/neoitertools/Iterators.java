...
public class Iterators {
	 ...
	 * @return
	 */
	public static <T> Iterator<T> iter(T[] t) {
	...
	/** turns any {@link Iterator} into an Iterable. Does not consume any extra storage, and thus, can only be used once.
	 * 
	 * @param <T>
	 * @param iterator
	 * @return
	 ...
	 * @return
	 */
	public <T> Iterator<T> reversed(Iterator<T> iterator){
	...
	// TODO public static <T,K> Iterator<Couple<K, Iterator<T>>>
	// groupby(Iterator<T> iterator, Mapper<T, K> key ){}
	// TODO itertools.ifilterfalse(predicate, iterable)
	// TODO cycle
	// TODO product
	// TODO repeat
	// TODO takewhile
